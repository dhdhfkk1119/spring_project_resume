...
| 사용자 유형   | HTTP Method | 경로 (URL)              | 설명                               | 뷰 템플릿           | 로그인 여부 |
|----------------|--------------|---------------------------|--------------------------------------|----------------------|--------------|
| 일반회원 (비로그인) | GET          | `/mypages`                | 마이페이지 기본 화면 (비로그인 시용)   | `mypages.mustache`   | ❌           |
| 일반회원 (로그인)   | GET          | `/mypages/my`             | 일반회원 마이페이지 (로그인 상태)     | `mypages.mustache`   | ✅           |
| 기업회원 (비로그인) | GET          | `/comp/mypages`           | 기업 마이페이지 기본 화면 (비로그인)  | `compmypages.mustache` | ❌           |
| 기업회원 (로그인)   | GET          | `/comp/mypages/my`        | 기업회원 마이페이지 (로그인 상태)     | `compmypages.mustache` | ✅           |
